      ...
      H.updateLanguage = function (e, n) {
        if ("string" == typeof e) {
          ...
          return (
            ...
            ((E.current_lang = i), q && ae(i), ce(i), !0)
          );
        }
      };
      var re = function (e) {
                ...
                for (var g = 0; g < f; g++) {
                  ...
                  if ((y && (h = [y, "." + y]), b))
                    for (var C = 0; C < i.length; C++)
                      i[C].match(m) && _.push(i[C]);
                  else {
                    var w = se(i, m);
                    w > -1 && _.push(i[w]);
                  }
                  _.length > 0 &&
                    (_e(_, k, h), "on_clear" === l.toggle.reload && (B = !0));
                }
              }
            }
          }
      ...
      (H.set = function (e, t) {
        return (
          ...
          (function (e, t) {
            var n = !1;
            if ("update" === t) {
              var i = typeof (J = H.get("data")) == typeof e;
              if (i && "object" == typeof J)
                for (var o in (!J && (J = {}), e))
                  J[o] !== e[o] && ((J[o] = e[o]), (n = !0));
              else (!i && J) || J === e || ((J = e), (n = !0));
            } else (J = e), (n = !0);
            return n && ((D.data = J), he(E.cookie_name, JSON.stringify(D))), n;
          })(t.value, t.mode)
        );
      }),
        (H.get = function (e, t) {
